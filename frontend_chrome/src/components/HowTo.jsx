          ...
          <div className="accordion-body">
            <div className="row">
              <div className="col text-center">
                ...
                Look at what I was involved in each day." Work is how you
                provide for all of the other important things in life. Let this
                app be an avenue to create a more concrete recap of what you've
                been up to, so you can form a richer mental narrative of your
                work endeavors that will make you more interesting during job
                interviews, networking event, or just anytime you get a chance
                ...
                have a Workdiary then? Of course it would be. Let me know how it
                goes ✌
              </div>
            </div>
