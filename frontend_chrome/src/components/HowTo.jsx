          ...
          <div className="accordion-body">
            <div className="row">
              <div className="col text-center">
                ...
                Look at what I was involved in each day." Think about it. Work
                is how you provide for all of the other important things in
                life. Let this app be an avenue to create a concrete recap of
                what you've been up to, so you can form a rich mental narrative
                of your work endeavors that will make you more interesting
                during job interviews, networking event, or just anytime you get
                a chance to say your piece. Many people have personal
                diaries...you spend most of your waking hours working...Why
                wouldn't it be good to have a Workdiary then? Of course it would
                be. Let me know how it goes ✌
              </div>
            </div>
