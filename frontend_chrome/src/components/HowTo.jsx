          ...
          <div className="accordion-body">
            <div className="row">
              <div className="col text-center">
                ...
                can use this hard proof to form a personal narrative about your
                worklife. Your work is your sustenance. Let this app be the tool
                you use the form a richer narrative about what you do for a
                living. Wallah! You are now an equipped storyteller. Use this
                work-story in job interviews, networking events, basically
                anytime you want to tell people who you are and what you do.
                Many people have personal diaries...you spend most of your
                waking hours working...Why wouldn't it be good to have a
                Workdiary then? Of course it would be. Let me know how it goes
                ✌
              </div>
            </div>
