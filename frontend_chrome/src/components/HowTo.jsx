    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col">
          <ol>
            ...
            <li>Click the green button to have your voice turned into text</li>
            <li>Add a tag to your note</li>
            <li>
              Pull your tabs for today (delete the ones you don't want to keep)
            </li>
            <li>
              Set your alarm so you can remember to come back tomorrow (it's
              already pre-set for 5pm)
      ...
      <div className="row">
        <div className="col">
          <ul>
            <li>
              To pick up where you left off in solving an old problem/bug (Save
              the relevant tabs to a given work day!)
            </li>
            <li>
              To recall what you did over the months so you can prepare for
              performance reviews
      ...
      <div className="row">
        <div className="col text-center">
          <h5 style={{ cursor: "pointer", textDecoration: "underline" }}>
            Who are we?
          </h5>
        </div>
      </div>
      <div className="row">
        <div className="col text-center">
          Hi, My name is Kuda Mwakutuya. I made this app because as a Software
          engineer, each day when I would open my laptop to start work, I would
          have a flurry of opened tabs that I would have to sift through to
          determine if they are relevant to today's mission. Plus it would be
          time for performance reviews, and I would feel like I had done so much
          work over the months but had no proof to show for it. Like sure, I
          added a feature to the app, but there was a buttload of work that went
          into making that. Where's the evidence for all of this backend work ??
          I want to be as prepared as possible to vouch for myself.
        </div>
      </div>
      <div className="row justify-content-between">
        ...
        <div className="col-auto">
          <a href="https://www.linkedin.com/in/kuda-mwakutuya/" target="_blank">
            <img src="linkedin.png" alt="Social Media 2" />
            My LinkedIn
          </a>
        </div>
